...
import { DataCubeService } from './perimetre-invst.service';
import { Chart, ChartOptions } from 'chart.js/auto';



@Component({
  selector: 'app-perimetre-invst',
  templateUrl: './perimetre-invst.component.html',
  styleUrl: './perimetre-invst.component.css'
})
export class PerimetreInvstComponent implements AfterViewInit {
  chartData: any;
  chartOptions: any;
