...
namespace api.Migrations
{
    ...
    [Migration("20240526133029_migrationtr2p")]
    partial class migrationtr2p
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("api.Models.DeclarationRedevance", b =>
                {
                    ...
                    b.Property<decimal>("BaseRdv")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("TauxRdv")
                        .HasColumnType("decimal(18,2)");

                    b.Property<DateOnly>("dateRdv")
                        .HasColumnType("date");

                    b.Property<decimal>("montantRdv")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("api.Models.Investissement", b =>
                {
                    ...
                    b.Property<DateOnly>("dateInvet")
                        .HasColumnType("date");

                    b.Property<decimal>("montantInvest")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("api.Models.PrixBase", b =>
                {
                    ...
                    b.Property<DateOnly>("dateModificationPb")
                        .HasColumnType("date");
            ...
            modelBuilder.Entity("api.Models.PrixMn", b =>
                {
                    ...
                    b.Property<DateOnly>("datemodificationPmn")
                        .HasColumnType("date");

                    b.Property<decimal>("prixMn")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("api.Models.Production", b =>
                {
                    ...
                    b.Property<decimal>("CoutTransport")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("ProductionValorise")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<decimal>("qteProduite")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("api.Models.TarifTransport", b =>
                {
                    ...
                    b.Property<DateOnly>("dateModificationTt")
                        .HasColumnType("date");

                    b.Property<decimal>("tarifTransport")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("api.Models.Trp", b =>
                {
                    ...
                    b.Property<decimal>("TauxTrp")
                        .HasColumnType("decimal(18,2)");

                    b.Property<DateOnly>("dateTrp")
                        .HasColumnType("date");

                    b.Property<decimal>("montantTrp")
                        .HasColumnType("decimal(18,2)");
